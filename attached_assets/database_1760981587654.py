...
class Database:
    ...
    def init_db(self):
        ...
        # Таблица для хранения информации о пользователях Emby
        cursor.execute('''
        ...
        # Таблица для хранения администраторов бота
        cursor.execute('''
        ...
        # Таблица для хранения группы администраторов
        cursor.execute('''
    ...
    def get_users_to_delete(self, days: int = 14) -> List[Tuple[str, str, datetime]]:
        ...
        # Вычисляем дату, до которой нужно удалить пользователей
